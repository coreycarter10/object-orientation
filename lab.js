...
let cat1 = new Cat('Feline', 3, 'black');
...
let newWizard = new Wizard('Harry', 14, 'poof');
...
let sidekick = new Phone('Tmobile', 'Sidekick', 1000, 'white', 20);
let nokia = new Phone('Nokia', 'Brick', 10, 'black', 50);
let razr = new Phone('Motorolla', 'Razr', 500, 'silver', 100);
...
const myFirstVehicle = new Vehicle(0, 'white', 7);
...
const myFirstMotorcycle = new Motorcycle(1, 'white', 100, 'Victory', true);
...
const myFirstBoat = new Boat(10, 'red', 50, 'Big Boat', 'Mastercraft', false);
